...
abstract class Item with _$Item {
  ...
  factory Item.fromFirestore(DocumentSnapshot<Map<String, Object?>> snapshot) {
...
abstract class ItemId with _$ItemId {
  const factory ItemId(String value) = _ItemId;

  factory ItemId.fromJson(Map<String, dynamic> json) => _$ItemIdFromJson(json);
}

@Freezed(toJson: true, fromJson: true)
abstract class ItemPath with _$ItemPath {
