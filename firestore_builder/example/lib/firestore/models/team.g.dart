...
_Team _$TeamFromJson(Map<String, dynamic> json) => _Team(
  ...
  dates: (json['dates'] as List<dynamic>?)
      ?.map(
        (e) => _$JsonConverterFromJson<Timestamp, Timestamp>(
          e,
...
Map<String, dynamic> _$TeamToJson(_Team instance) => <String, dynamic>{
  ...
  'dates': instance.dates
      ?.map(
        (e) => _$JsonConverterToJson<Timestamp, Timestamp>(
          e,
...
_TeamId _$TeamIdFromJson(Map<String, dynamic> json) =>
    _TeamId(json['value'] as String);

Map<String, dynamic> _$TeamIdToJson(_TeamId instance) => <String, dynamic>{
