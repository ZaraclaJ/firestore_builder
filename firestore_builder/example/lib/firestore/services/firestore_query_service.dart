...
class FirestoreQueryService {
  ...
  Future<void> updateTeam({
    ...
    UpdatedValue<List<Timestamp?>?>? dates,
    UpdatedValue<List<List<int>>?>? bytes,
    ...
    final data = {
      ...
      if (dates != null) Team.datesFieldKey: dates.value,
      if (bytes != null) Team.bytesFieldKey: bytes.value,
